...
export default function CourseChangeForm({ navigation }: { navigation: any }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <Text style={styles.title}>Course Change Request</Text>
        <Text style={styles.subtitle}>
          Please fill in the details for your course change request.
        </Text>
        {renderFormField(
          "Program you wish to change to",
          formData.program,
          (text) => setFormData({ ...formData, program: text }),
          true
        )}
        {renderFormField("Reason for Changing", formData.reason, (text) =>
